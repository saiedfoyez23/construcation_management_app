...
class EmployeePrivacyAndPolicy extends StatelessWidget {
  EmployeePrivacyAndPolicy({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: HtmlWidget(
                            '''${employeeProfileController.getEmployeeAllSettingDataResponseModel.value.data?.privacyPolicy ?? "No Privacy and Policy"}''',
