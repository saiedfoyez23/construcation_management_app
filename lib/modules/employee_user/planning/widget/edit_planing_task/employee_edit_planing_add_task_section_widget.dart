...
class EmployeeEditPlaningAddTaskSectionWidget {

  Widget employeeEditPlaningAddTaskSectionBuilder({
...
// Handler functions
  Future<void> _handleAddTask({
    ...
    if (controller.taskNameController.value.text.isEmpty) {
      ...
      jsonEncode(data);
      await controller.addTasksPlaningController(planingId: controller.getEmployeePlanDetailsResponseModel.value.data?.sId, data: data);
