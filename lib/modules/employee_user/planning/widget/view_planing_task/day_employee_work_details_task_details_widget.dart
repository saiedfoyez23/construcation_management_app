...
class EmployeePlaningTaskDetailsWidget {

  Widget employeePlaningTaskDetailsBuilder({
    required BuildContext context,
    required EmployeeGetPlaningDetailsController controller,
    required EmployeePlaningDetailsTask item,
  }) {
    return Container(
      width: 375.w(context),
