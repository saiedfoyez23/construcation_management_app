class GetEmployeePlanDetailsResponseModel {
  var success;
  var message;
  GetEmployeePlanDetails? data;

  GetEmployeePlanDetailsResponseModel({this.success, this.message, this.data});

  GetEmployeePlanDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetEmployeePlanDetails.fromJson(json['data']) : null;
  }
...
class GetEmployeePlanDetails {
  ...
  GetEmployeePlanDetails.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
