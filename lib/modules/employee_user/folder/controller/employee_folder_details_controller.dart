...
import 'package:construction_management_app/modules/employee_user/folder/model/get_employee_folders_details_response_model.dart';
...
class EmployeeFolderDetailsController extends GetxController {
  Rx<LoginResponseModel> loginResponseModel = LoginResponseModel().obs;
  Rx<TextEditingController> searchController = TextEditingController().obs;
  Rx<TextEditingController> folderNameController = TextEditingController().obs;
  Rx<GetEmployeeFoldersDetailsResponseModel> getEmployeeFoldersDetailsResponseModel = GetEmployeeFoldersDetailsResponseModel().obs;
  RxList<GetEmployeeFoldersDetails> getEmployeeFileList = <GetEmployeeFoldersDetails>[].obs;
  RxList<GetEmployeeFoldersDetails> getEmployeeFileSearchList = <GetEmployeeFoldersDetails>[].obs;
  RxBool isLoading = false.obs;
  RxBool isDelete = false.obs;
  String folderId;
  EmployeeFolderDetailsController({required this.folderId});
  ...
  void onInit() {
    ...
    Future.delayed(Duration(seconds: 1),() async {
      await getEmployeeFolderDetailsController(folderId: folderId);
    });
  }
  ...
  Future<void> cleanList() async {
    ...
    getEmployeeFileSearchList.clear();
  }


  Future<void> refreshList() async {
    getEmployeeFileList.refresh();
    getEmployeeFileSearchList.refresh();
  }


  Future<void> getEmployeeFolderDetailsController({required String folderId}) async {
    try {
      ...
      if (responseBody != null) {
        ...
        getEmployeeFoldersDetailsResponseModel.value = GetEmployeeFoldersDetailsResponseModel.fromJson(responseBody);
        getEmployeeFoldersDetailsResponseModel.value.data?.files?.forEach((value) {
          getEmployeeFileList.add(value);
          getEmployeeFileSearchList.add(value);
        });
