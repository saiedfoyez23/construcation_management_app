...
class EmployeeAddSiteDiaryController extends GetxController {
  ...
  RxList<EmployeeWorkforce> workforceList = <EmployeeWorkforce>[].obs;
  RxList<EmployeeEquipment> equipmentList = <EmployeeEquipment>[].obs;
  RxList<EmployeeTask> taskList = <EmployeeTask>[].obs;
...
class EmployeeTask {
  final String name;
  final List<EmployeeWorkforce> workforce;
  final List<EmployeeEquipment> equipment;

  EmployeeTask(this.name, this.workforce, this.equipment);
}

class EmployeeWorkforce {
  final String typeId;
  final int quantity;
  final int duration;

  EmployeeWorkforce(this.typeId, this.quantity, this.duration);
}
...
class EmployeeEquipment {
  ...
  EmployeeEquipment(this.typeId, this.quantity, this.duration);
}
