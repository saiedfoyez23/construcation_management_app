...
import 'package:construction_management_app/modules/company_user/site_diary/widget/add_site_diary_widget/new_site_diary_widget.dart';
...
class NewEmployeeSiteDiaryController extends GetxController {
  ...
  RxList<EmployeeNewSiteDiaryWorkforce> workforceList = <EmployeeNewSiteDiaryWorkforce>[].obs;
  RxList<EmployeeNewSiteDiaryEquipment> equipmentList = <EmployeeNewSiteDiaryEquipment>[].obs;
  RxList<EmployeeNewSiteDiaryTask> taskList = <EmployeeNewSiteDiaryTask>[].obs;
  ...
  String projectId;
  NewEmployeeSiteDiaryController({required this.projectId});
...
class EmployeeNewSiteDiaryWorkforce {
  final String typeId;
  final int quantity;
  final int duration;

  EmployeeNewSiteDiaryWorkforce(this.typeId, this.quantity, this.duration);
}

class EmployeeNewSiteDiaryEquipment {
  final String typeId;
  final int quantity;
  final int duration;

  EmployeeNewSiteDiaryEquipment(this.typeId, this.quantity, this.duration);
}