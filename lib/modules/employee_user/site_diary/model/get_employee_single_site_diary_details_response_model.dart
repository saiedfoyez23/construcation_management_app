class GetEmployeeSingleSiteDiaryDetailsResponseModel {
  bool? success;
  String? message;
  GetEmployeeSingleSiteDiaryDetailsResponse? data;

  GetEmployeeSingleSiteDiaryDetailsResponseModel({this.success, this.message, this.data});

  GetEmployeeSingleSiteDiaryDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetEmployeeSingleSiteDiaryDetailsResponse.fromJson(json['data']) : null;
  }
...
class GetEmployeeSingleSiteDiaryDetailsResponse {
  var sId;
  AddedBy? addedBy;
  var name;
  User? project;
  ...
  GetEmployeeSingleSiteDiaryDetailsResponse({
    this.sId,
    this.addedBy,
    this.name,
    this.project,
  ...
  GetEmployeeSingleSiteDiaryDetailsResponse.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
