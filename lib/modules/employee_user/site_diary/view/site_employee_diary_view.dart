...
class SiteEmployeeDiaryView extends StatelessWidget {
  SiteEmployeeDiaryView({super.key,required this.projectId});

  final String projectId;

  @override
  Widget build(BuildContext context) {
    SiteEmployeeDiaryController siteEmployeeDiaryController = Get.put(SiteEmployeeDiaryController(projectId: projectId));
    return Scaffold(
      body: SafeArea(
        child: Container(
          ...
          child: Obx(()=>siteEmployeeDiaryController.isLoading.value == true  ?
          ...
          RefreshIndicator(
            ...
            child: CustomScrollView(
              slivers: [
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            CustomButtonHelper.textWithIconButton(
                              ...
                              height: 40,
                              onPressed: () async {
                                Get.off(()=>NewEmployeeSiteDiaryView(projectId: projectId),preventDuplicates: false);
                              },
                              text: "Upload New Log",
                              icon: Icons.add,
                        ...
                        CustomTextFormFieldClass.build(
                          context: context,
                          controller: siteEmployeeDiaryController.searchController.value,
                          ...
                          onChanged: (siteDiaryValue) async {
                            if(siteDiaryValue == "") {
                              siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.value = siteEmployeeDiaryController.getEmployeeAllSiteDiariesResponseList;
                              siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.refresh();
                            } else {
                              siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.value = siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.where((value)=>value.name.toString().toLowerCase().contains(siteDiaryValue.toString().toLowerCase()) == true).toList();
                            }
                          },
                        ),
                ...
                siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.isEmpty == true ?
                SliverToBoxAdapter(
                  child: Column(
                    children: [
                ...
                SliverList(delegate: SliverChildBuilderDelegate(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        TextHelperClass.headingText(
                                          context: context,
                                          text: siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].name,
                                          fontSize: 18,
                                        ...
                                        TextHelperClass.headingText(
                                          context: context,
                                          text: siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].location,
                                          fontSize: 15,
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Expanded(
                                                child: TextHelperClass.headingText(
                                                  context: context,
                                                  text: siteEmployeeDiaryController.getTimeDifference(siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].createdAt),
                                                  fontSize: 15,
                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          children: [
                                                            ...
                                                            siteEmployeeDiaryController.isDelete.value == true ?
                                                            CustomLoaderButton().customLoaderButton(
                                                              backgroundColor: Colors.transparent,
                                                              loaderColor: Color.fromRGBO(38, 50, 56, 1),
                                                              height: 50,
                                                            ...
                                                            CustomButtonHelper.customRoundedButton(
                                                              ...
                                                              onPressed: () async {
                                                                siteEmployeeDiaryController.isDelete.value = true;
                                                                await siteEmployeeDiaryController.deleteEmployeeSiteDiaryController(
                                                                  siteDiaryId: siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].sId,
                                                                );
                                                              },
                                                            ),
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: TextHelperClass.headingText(
                                      context: context,
                                      text: "${siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].totalWorkforces} Workforce",
                                      fontSize: 15,
                                      textColor: Color.fromRGBO(75, 85, 99, 1),
                                      fontWeight: FontWeight.w500,
                                    ),
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: TextHelperClass.headingText(
                                      context: context,
                                      text: "${siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList[index].totalEquipments} Equipments",
                                      fontSize: 15,
                                      textColor: Color.fromRGBO(75, 85, 99, 1),
                                      fontWeight: FontWeight.w500,
                                    ),
                    ...
                    childCount: siteEmployeeDiaryController.getEmployeeAllSiteDiariesSearchResponseList.length
                ),),
