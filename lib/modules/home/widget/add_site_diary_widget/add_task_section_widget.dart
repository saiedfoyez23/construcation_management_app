...
// Helper function for Workforce section
  Widget _buildWorkforceSection({required BuildContext context,required dynamic controller}) {
    return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomDropdownHelperClass<String>(
                      ...
                      value: controller.selectedWorker.value.isEmpty ? null : controller.selectedWorker.value,
                      items: ['Laborers', 'Engineer', 'Electrician'],
                      onChanged: (value) => controller.selectedWorker.value = value!,
                    ),
                  ],
                ),
              ),
...
// Helper function for Equipment section
  Widget _buildEquipmentSection({required BuildContext context, required dynamic controller}) {
    return Padding(
      padding: EdgeInsets.only(
        left: 16.lpm(context),
        right: 16.rpm(context),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomDropdownHelperClass<String>(
                      ...
                      value: controller.selectedEquipment.value.isEmpty ? null : controller.selectedEquipment.value,
                      items: ['Excavator', 'Concrete Mixer'],
                      onChanged: (value) => controller.selectedEquipment.value = value!,
                    ),
                  ],
                ),
              ),
...
// Handler functions
  ...
  void _handleAddWorkforce({
    ...
    if (controller.selectedWorker.value.isEmpty ||
  ...
  void _handleAddEquipment({
    ...
    if (controller.selectedEquipment.value.isEmpty ||
