  ...
  Widget _buildRemoveTaskButton({
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        onPressed: () => controller.taskList.remove(item),
    ...
    return Column(
      ...
      children: [
        ...
        ...item.workforce.map((workforceItem) => _buildAddedItem(
          title: '${workforceItem.quantity} ${workforceItem.type}',
...
// Helper Widget for Equipment Details Section
  Widget _buildEquipmentDetailsSection({required BuildContext context, required Task item}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        TextHelperClass.headingText(
        ...
        ...item.equipment.map((equipmentItem) => _buildAddedItem(
          title: '${equipmentItem.quantity} ${equipmentItem.type}',
