...
class EmailVerifyView extends StatelessWidget {
  EmailVerifyView({super.key,required this.email});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormFieldClass.otpInputFiledBuild(
                          pinController: emailVerifyController.pinController.value,
                          context: context,
                          onCompleted: (pin) {
                            print(pin);
                          },
                        ...
                        emailVerifyController.timeCounter.value > 0 ?
                        CustomButtonHelper.customRichTextButton(
                          ...
                          highlightedText: ' ${emailVerifyController.timeCounter.value}s',
                          onPressed: null,
