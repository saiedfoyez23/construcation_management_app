        ...
        child: Obx(()=>Container(
          ...
          CustomScrollView(
            slivers: [
                                        ...
                                        children: [
                                          ...
                                          Column(
                                            children: [
                                              ...
                                              notificationController.isDelete.value == true ?
                                              CustomLoaderButton().customLoaderButton(
                                                backgroundColor: Colors.transparent,
                                                loaderColor: Color.fromRGBO(38, 50, 56, 1),
                                                height: 50,
                                              ...
                                              CustomButtonHelper.customRoundedButton(
                                                ...
                                                onPressed: () async {
                                                  notificationController.isDelete.value = true;
                                                  await notificationController.deleteAllNotificationController();
                                                },
                                              ),
              ...
              notificationController.getAllNotificationResponseModel.value.data?.data?.isEmpty == true ?
              SliverToBoxAdapter(
                child: Column(
                  children: [
              ...
              SliverList(delegate: SliverChildBuilderDelegate(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      TextHelperClass.headingText(
                                        context: context,
                                        text: notificationController.getAllNotificationResponseModel.value.data?.data?[index].body,
                                        fontSize: 18,
                                                        ...
                                                        children: [
                                                          ...
                                                          CustomButtonHelper.customRoundedButton(
                                                            ...
                                                            onPressed: () async {
                                                              notificationController.isDelete.value = true;
                                                              notificationController.isDelete.value = true;
                                                              await notificationController.deleteSingleNotificationController(notificationId: notificationController.getAllNotificationResponseModel.value.data?.data?[index].sId);
                                                            },
                                                          ),
                  ...
                  childCount: notificationController.getAllNotificationResponseModel.value.data?.data?.length
              ),),
