class GetSingleSiteDiaryDetailsResponseModel {
  bool? success;
  String? message;
  GetSingleSiteDiaryDetailsResponse? data;

  GetSingleSiteDiaryDetailsResponseModel(
      {this.success, this.message, this.data});

  GetSingleSiteDiaryDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetSingleSiteDiaryDetailsResponse.fromJson(json['data']) : null;
  }
...
class GetSingleSiteDiaryDetailsResponse {
  var sId;
  AddedBy? addedBy;
  var name;
  User? project;
  ...
  GetSingleSiteDiaryDetailsResponse({
    this.sId,
    this.addedBy,
    this.name,
    this.project,
  ...
  GetSingleSiteDiaryDetailsResponse.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
