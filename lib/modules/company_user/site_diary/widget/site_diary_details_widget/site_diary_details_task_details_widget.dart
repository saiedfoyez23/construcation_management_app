...
class SiteDiaryDetailsTaskDetailsWidget {

  Widget siteDiaryDetailsTaskDetailsBuilder({
    required BuildContext context,
    required GetSiteDiaryDetailsController controller,
    required SiteDiaryDetailsTask item,
  }) {
    return Container(
      width: 375.w(context),
