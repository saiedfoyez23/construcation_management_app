class GetPostPourInspectionReportResponseModel {
  var success;
  var message;
  GetPostPourInspectionReportResponse? data;

  GetPostPourInspectionReportResponseModel(
      {this.success, this.message, this.data});

  GetPostPourInspectionReportResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetPostPourInspectionReportResponse.fromJson(json['data']) : null;
  }
...
class GetPostPourInspectionReportResponse {
  ...
  GetPostPourInspectionReportResponse({
    this.settingOut,
    this.sId,
    this.project,
    this.pourNo,
  ...
  GetPostPourInspectionReportResponse.fromJson(Map<String, dynamic> json) {
