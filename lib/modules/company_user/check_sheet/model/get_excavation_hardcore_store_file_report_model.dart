class GetExcavationHardcoreStoreFileReportModel {
  var success;
  var message;
  GetExcavationHardcoreStoreFileReport? data;

  GetExcavationHardcoreStoreFileReportModel(
      {this.success, this.message, this.data});

  GetExcavationHardcoreStoreFileReportModel.fromJson(
      Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetExcavationHardcoreStoreFileReport.fromJson(json['data']) : null;
  }
...
class GetExcavationHardcoreStoreFileReport {
  var sId;
  var project;
  var contract;
  var date;
  ...
  GetExcavationHardcoreStoreFileReport({
    this.sId,
    this.project,
    this.contract,
    this.date,
  ...
  GetExcavationHardcoreStoreFileReport.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
