class GetDuctingReportResponseModel {
  var success;
  var message;
  GetDuctingReportResponse? data;

  GetDuctingReportResponseModel({this.success, this.message, this.data});

  GetDuctingReportResponseModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new GetDuctingReportResponse.fromJson(json['data']) : null;
  }
...
class GetDuctingReportResponse {
  var sId;
  var project;
  var contract;
  var date;
  ...
  GetDuctingReportResponse.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
