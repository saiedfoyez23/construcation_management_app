...
class GetDrainageDuctingReportController extends GetxController {

  String projectId;
  RxBool isLoading = false.obs;
  RxBool isPdf = false.obs;
  RxBool isExcelOpen = false.obs;
  GetDrainageDuctingReportController({required this.projectId});
  ...
  Future<Uint8List> generatePdf(GetDuctingReportResponseModel data) async {
    isPdf.value = true;
  ...
  /// ---------- SAVE + OPEN ----------
  Future<void> createAndOpenPdf(GetDuctingReportResponseModel response) async {
...
// Generate Excel file
  Future<void> generateAndOpenExcel(GetDuctingReportResponseModel data) async {
