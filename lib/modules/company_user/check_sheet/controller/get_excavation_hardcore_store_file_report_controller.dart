...
class GetExcavationHardcoreStoreFileReportController extends GetxController {
  ...
  GetExcavationHardcoreStoreFileReportController({required this.projectId});
  ...
  Future<Uint8List> generatePdf(GetExcavationHardcoreStoreFileReportModel data) async {
    isPdf.value = true;
  ...
  /// ---------- SAVE + OPEN ----------
  Future<void> createAndOpenPdf(GetExcavationHardcoreStoreFileReportModel response) async {
...
// Generate Excel file
  Future<void> generateAndOpenExcel(GetExcavationHardcoreStoreFileReportModel data) async {
