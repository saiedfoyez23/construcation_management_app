...
import 'package:construction_management_app/modules/company_user/message/view/message_view.dart';
                        ...
                        (context, int index) {
                          if(getMyChatGroupsController.getMyChatGroupsResponseModel.value.data?.data?[index].project != null) {
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  Get.off(()=>MessageView(groupChatId: getMyChatGroupsController.getMyChatGroupsResponseModel.value.data?.data?[index].sId, projectName: getMyChatGroupsController.getMyChatGroupsResponseModel.value.data?.data?[index].project?.name));
                                },
                                child: Container(
                                  width: 375.w(context),
                                  decoration: BoxDecoration(
