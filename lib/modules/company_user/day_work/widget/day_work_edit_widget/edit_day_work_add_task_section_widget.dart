...
class EditDayWorkAddTaskSectionWidget {

  Widget editDayWorkAddTaskSectionBuilder({
...
// Handler functions
  Future<void> _handleAddTask({
    ...
    if (controller.taskNameController.value.text.isEmpty) {
      ...
      jsonEncode(data);
      await controller.addTasksDayWorkController(dayWorkId: controller.getSingleDayWorkDetailsResponseModel.value.data?.sId, data: data);
